...
<body>
    ...
    <div class="container">
        ...
        <a href="kuliah_latihan1.php" class="btn btn-light my-3">Kembali Ke Daftar Mahasiswa</a>
        ...
        <div class="row mt-3">
            ...
            <div class="col-8">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <button type="submit" name="tambah" class="btn btn-success">Tambah Data Mahasiswa</button>
